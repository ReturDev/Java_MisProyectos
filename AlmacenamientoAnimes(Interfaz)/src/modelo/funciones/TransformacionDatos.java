...
public class TransformacionDatos {
	...
	/**
	 * Método encargado de transformar una lista de nodos del xml a un ArrayList de PiezasAudiovisuales.
		...
		HashSet<PiezaAudiovisual> piezas = new HashSet<PiezaAudiovisual>();
			...
			for(int i = 0; i < lista.getLength(); i++) {
				...
				if(lista.item(i).getNodeType() == Node.ELEMENT_NODE) {
					...
					//Se obtiene el estado del elemento, a través del método encargado de transformal el texto al valor del enum.
	...
	/**
	 * Método encargado de obtener las temporadas del archivo XML.
	...
	/**
	 * Método encargado de transformar el valor del atributo estado en el XML a un valor del enum Estados.
